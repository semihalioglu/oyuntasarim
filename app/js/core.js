import StorageManager from './storageManager.js?v=1.047';
import UIManager from './uiManager.js?v=1.047';
import GameManager from './gameManager.js?v=1.047';
import Drawing from './drawing.js?v=1.047';
...
function draw(){
  ...
  if(S.weather==='yağmurlu'){
    ...
    bgG.addColorStop(0,`rgba(140,185,225,${0.3+bgDl*0.7})`);
    bgG.addColorStop(0.12,`rgba(170,205,230,${0.3+bgDl*0.7})`);
    bgG.addColorStop(0.2,`rgba(200,220,195,${0.3+bgDl*0.7})`);
    bgG.addColorStop(0.25,`rgba(210,225,185,${0.3+bgDl*0.7})`);
  }
  bgG.addColorStop(0.3,'#6da048');bgG.addColorStop(1,'#3a6c22');
  ...
  g2.addColorStop(0,'#5a9a3e');g2.addColorStop(1,'#4a8a2e');
